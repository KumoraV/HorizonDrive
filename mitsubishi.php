...
<body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            ...
                            <?php
                                $sql = "SELECT * FROM products WHERE Brand='Mitsubishi'";
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-bt9b4f9CF0W2zXGGg4Cj5f5OMC1LaLr6r6Buhg7pCjy4f/C9JlxIMVX7eBO"
